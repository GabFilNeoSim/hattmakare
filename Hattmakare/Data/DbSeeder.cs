...
public static class DbSeeder
{
    ...
    private static async Task AddMaterials(AppDbContext context)
    {
        ...
        [
            ...
            new Material { Name = "Rishalm", Unit = "kg", Price = 109.20m, Supplier = "StrawCraft Asia", IsDecoration = true },
            new Material { Name = "Palmlöv", Unit = "kg", Price = 94.60m, Supplier = "Tropic Naturals", IsDecoration = true },
            new Material { Name = "Majsblad", Unit = "kg", Price = 134.95m, Supplier = "EcoFiber Mexico", IsDecoration = true },
